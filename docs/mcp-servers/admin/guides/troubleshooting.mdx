...
<AccordionGroup>
  <Accordion title="Check parameter requirements">
    ...
    **Solution**: Review tool documentation:
    - [Blocks Tools](/mcp-servers/admin/tools/content/manage-block)
    - [Products Tools](/mcp-servers/admin/tools/products/manage-product)
    - [Customers Tools](/mcp-servers/admin/tools/customers/manage-customer)
