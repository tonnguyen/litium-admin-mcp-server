...
description: "The new version 8.16 of the Litium platform contains two new discount abilities and new storefront API capabilities including API support for Google Analytics."
---
