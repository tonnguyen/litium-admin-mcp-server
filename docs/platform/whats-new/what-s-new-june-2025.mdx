...
description: "We are excited to introduce the new June version of Litium, a release packed with powerful enhancements to improve usability, a new Litium connect taxes api, strengthen integrations across the e-commerce ecosystem and introducing safe order editing with the new framework admin actions."
---
