...
- GraphQL
- Storefront API knowledge. If you are new, please read this [article](/platform/apis/storefront-api).
- Storefront API playground. If you are new, please read this [article](/platform/apis/storefront-api).
...

{
    ...
    "customer": {
        ...
        "lastName": "Ström",
        "title": "PhD.",
        "email": "Caroline\_Bjrklund@gmail.com",
...
If you select other payments such as Klarna or Adyen, they have their own widget. It will be populated into _paymentHtmlSnippet_ field. Read this [article](/accelerators/react-accelerator/working-with-shopping-cart-and-checkout) to see how React Accelerator renders the widget.
...
In case of the payment providers having their own receipt page, it will be populated in _htmlSnippet_ field. Read this [article](/accelerators/react-accelerator/working-with-shopping-cart-and-checkout) to see how React Accelerator uses this property.
