...
Create class _ProductIsAvailableForSale_ inherited from class `ValidationRuleBase<ValidateCartContextArgs>` and implement the logic of validating in the method _Validate_
