...
Verify that there is an upgraded version of the [add-on](/apps/overview) or an [app](/apps/overview) that supports the new Litium version. The supported version information is displayed in the documentation for [Litium add-ons](/apps/overview) and [Litium apps](/apps/overview).
...
If an add-on or ability is not supported yet, or if you require more information regarding differences in functionality, please contact [Litium support](/cloud/serverless/overview) to get information about add-on compatibility and upgrade options.
