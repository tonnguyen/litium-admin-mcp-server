...
2.  Cache is king when it comes to performance problems. Make use of [Litium distributed cache](/platform/architecture/distributed-caching), you can find an **[implementation example](https://start.litium.dev/tutorials/installation/customize/price-calculator#cache-the-external-price)** in the installation tutorial.
