...
![Screenshot 2023-03-27 at 18.53.39.png](./media/Screenshot%202023-03-27%20at%2018.53.39.png)
...
export const TEXT\_BLOCK\_FRAGMENT = gql\`
...
import { gql } from '@apollo/client';
import { BANNER\_BLOCK\_FRAGMENT } from './banner';
import { TEXT\_BLOCK\_FRAGMENT } from './text';

export const ALL\_BLOCK\_TYPES\_FRAGMENT = gql\`
  ...
  ${BANNER\_BLOCK\_FRAGMENT}
  ${TEXT\_BLOCK\_FRAGMENT}
\`;
...
export const TWO\_COLUMNS\_FRAGMENT = gql\`
...
import { BANNER\_BLOCK\_FRAGMENT } from './banner';
import { TEXT\_BLOCK\_FRAGMENT } from './text';
import { TWO\_COLUMNS\_FRAGMENT } from './twoColumns';
