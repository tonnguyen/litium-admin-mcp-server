...
![state mapping L7 to L8.jpg](./media/state-mapping-L7-to-L8.jpg)
...
You may map any custom state to a defined state in Litium 8 using the same script, and create a tag to denote the state in Litium 7. Use the [Tagging feature in Litium 8](/platform/get-started/concepts) to control the flow of the states.
