...
If you have done the setup of [payment and shipping apps](/platform/guides/local-installation-guide-configure-payment-and-shipment-apps) you can also test the the order confirmation e-mail.
...
[Setup automated tests](/platform/guides/local-installation-guide-configure-test-project)
