...
[Read about products data modeling](/platform/areas/data-modelling/product-data-modeling)
...
- [Websites data modeling](/platform/areas/data-modelling/websites-data-modeling)
...
[Read more about globalization configuration scenarios for markets and channels](/platform/areas/globalization/globalization-configuration-scenarios)
...
- Customer **roles** are set as an attribute on the link between a **Person** and an **Organization**. A **Person** can for example be connected to an **Organization** with the role _"Manager"_. **Roles** are used in Litium accelerator to handle [the order approval flow](/platform/areas/sales/order-approval).
...
- **Target groups** are behavior defined groups used for personalization.
    ...
    - Read more about [target groups](/platform/areas/customers/target-groups).
- To comply with GDPR, Litium supports exporting and removing user information. Extra audit information is also stored when a user with access to customers or orders logs in. Read more about [GDPR](/platform/areas/data-modelling/gdpr-support).
    

[Read about customers data modeling](/platform/areas/data-modelling/customers-data-modeling)
...
[Read about media data modeling](/platform/areas/data-modelling/media-data-modeling)
...
- [Settings pages](/platform/guides/back-office-ui-extensions/how-to-create-a-custom-page-under-settings)
...
2.  Extensions
    ...
    - Source code
        - Source code is [downloaded](/resources/download-add-ons)
        - Run as part of the Litium application
...
- [**Payment providers**](/add-ons/litium-apps): Many supported such as Klarna, Svea, Briqpay and Adyen
- [**Product Media Mapper**](/add-ons/add-ons-as-extensions/connectors-product-extensions/product-media-mapper): Automatically connects uploaded images to products (compiled extension)
- [**Integration kit**](/add-ons/add-ons-as-extensions/connectors-product-extensions/litium-integration-kit): A codebase used to develop file based integrations towards Litium (source code extensions)

[See the full list of available Add-ons](/resources/download-add-ons)

[Read more about building add-ons](/add-ons/get-started)
