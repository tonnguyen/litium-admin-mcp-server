...
Please read the [system requirements](/platform/get-started/system-requirements) to verify the compatibility of the hosting environment and the Litium system before installing Litium.
