...
A customer solution can be extended further by add-ons and [Litium Apps](/apps/overview), which are defined functionalities that can be added to the accelerator. The illustration below shows the context of the accelerator.
