...
Please read more about working with payment providers in the [Apps documentation](/apps/overview).
...
Payment providers and methods can be downloaded as Litium Add-ons. Please read more about [payment providers here](/platform/areas/sales/payment-extensions). Always consult the respective payment providers regarding installation and configuration.
