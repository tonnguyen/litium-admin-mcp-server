...
New customers will get access to Serverless Cloud from start. Existing customers are being granted access on an ongoing basis, if you haven't yet got access and would like to speed up the process, please reach out to our [support team](/cloud/serverless/overview).

## Learn more & Getting started

Start by digging into the [Getting started documentation](/cloud/serverless/overview) where you can read all about the basics and dig even deeper into the advantagees meantioned above.
