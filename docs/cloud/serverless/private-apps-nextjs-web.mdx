---
title: "Next.js Web"
description: "Host your private Next.js web app if you for example want additional storefronts connected to your Litium app."
---
Host your private Next.js web app if you for example want additional storefronts connected to your Litium app.

## Pricing

Next.js Web is priced per hour based on selected app plan. [Read more about prices](/cloud/serverless/private-apps-pricing)
...
```powershell
litium-cloud marketplace manifest --app nextjs-web -f enter-any-name.yaml
```
...
**Id**: Choose your own unique-per-environment id of the app. Suggested "nextjs-web"

### Artifact

To deploy your code you need to first [create a next.js artifact](/cloud/serverless/artifacts-create-nextjs-artifact) and refer the artifact id to the property "artifact".
...
To install a Next.js web private app you need to provide a plan when creating the app. Pricing is based on which plan you select. Run following command to view available plans for Next.js web app:

```powershell
litium-cloud marketplace show --app nextjs-web
```
...
This will create a Next.js web app in the given environment. 
...
```powershell
litium-cloud marketplace show --app nextjs-web --details --version add-version-here
```
