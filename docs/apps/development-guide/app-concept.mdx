...
A public app is available to all Litium customers. Public apps can be installed to any customer environment in Litium Commerce Cloud through the [Litium Cloud CLI](/cloud/serverless/getting-started-with-cloud-cli). Public apps can be developed and maintained by Litium, eg the [Klarna payment app](/apps/klarna-payment/overview) and the [Direct shipment app](/apps/direct-shipment/overview), but can also be owned by a Technology Partner, eg the [Briqpay payment app](/apps/briqpay-payment/overview). Before a public app built by a Technology Partner can be released, a Public app agreement must be signed between Litium and the partner. If you are interested in building a public app, please [contact Litium](mailto:support@litium.com).
