...
For earlier versions of Litium, please see the [Briqpay extension](/apps/briqpay-payment/overview).

## Installation

Litium serverless cloud - Use the [Cloud CLI](/cloud/serverless/overview) to install the app.
